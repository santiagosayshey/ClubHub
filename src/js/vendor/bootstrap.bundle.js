...
(function (global, factory) {
 ...
 ...this.constructor.Default,
  ...
  function arrow(_ref) {
    ...
    var { popperOffsets } = state.modifiersData;
  ...
  function mapToStyles(_ref2) {
    ...
    var { popper } = _ref2;
        var { popperRect } = _ref2;
        var { placement } = _ref2;
        var { variation } = _ref2;
        var { offsets } = _ref2;
        var { position } = _ref2;
        var { gpuAcceleration } = _ref2;
        var { adaptive } = _ref2;
        var { roundOffsets } = _ref2;
        var { isFixed } = _ref2;
    ...
    var commonStyles = { position: position, ...adaptive && unsetSides };
...
offsets: state.modifiersData.arrow,
  ...
  function isScrollParent(element) {
    ...
    var _getComputedStyle = getComputedStyle$1(element);
        var { overflow } = _getComputedStyle;
        var { overflowX } = _getComputedStyle;
        var { overflowY } = _getComputedStyle;
...
left: rect.x,
  ...
  function detectOverflow(state, options) {
    ...
    var popperClientRect = rectToClientRect({ ...popperRect, ...popperOffsets });
  ...
  function computeAutoPlacement(state, options) {
    ...
    var _options = options;
        var { placement } = _options;
        var { boundary } = _options;
        var { rootBoundary } = _options;
        var { padding } = _options;
        var { flipVariations } = _options;
  ...
  function flip(_ref) {
    ...
    var _options$mainAxis = options.mainAxis;
        ...
        var { rootBoundary } = options;
        var { altBoundary } = options;
        ...
        var { allowedAutoPlacements } = options;
...
'data-popper-reference-hidden': isReferenceHidden,
  ...
  function distanceAndSkiddingToXY(placement, rects, offset) {
    ...
    var _ref = typeof offset === 'function' ? offset({ ...rects, placement: placement }) : offset;
        var skidding = _ref[0];
        var distance = _ref[1];
  ...
  function offset(_ref2) {
    ...
    var _data$state$placement = data[state.placement];
        var { x } = _data$state$placement;
        var { y } = _data$state$placement;
  ...
  function preventOverflow(_ref) {
    ...
    var referenceRect = state.rects.reference;
    var popperRect = state.rects.popper;
    var tetherOffsetValue = typeof tetherOffset === 'function' ? tetherOffset({ ...state.rects, placement: state.placement }) : tetherOffset;
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          var _state$elements = state.elements;
              var { reference } = _state$elements;
              var { popper } = _state$elements; // Don't proceed if `reference` or `popper` are not valid elements
          // anymore
          ...
          for (var index = 0; index < state.orderedModifiers.length; index++) {
            ...
            var _state$orderedModifie = state.orderedModifiers[index];
                ...
                var { name } = _state$orderedModifie;
      ...
      function runModifierEffects() {
        state.orderedModifiers.forEach(function (_ref3) {
          var { name } = _ref3;
              ...
              var options = _ref3$options === void 0 ? {} : _ref3$options;
              var { effect } = _ref3;
